 ...
 */
class Version20180502091526 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, created_at, contacts, updated_at FROM user');
        ...
        , created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, contacts VARCHAR(12) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, created_at, contacts, updated_at) SELECT id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, created_at, contacts, updated_at FROM __temp__user');
    ...
    public function down(Schema $schema)
    {
        ...
        , created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, contacts VARCHAR(16) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
