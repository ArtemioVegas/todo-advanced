 ...
 */
class Version20170611073011 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, user_id, project_id, task_name, upload_file, image_path, created_at, updated_at, complete_date, is_done, due_date FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER NOT NULL, user_id INTEGER NOT NULL, project_id INTEGER NOT NULL, task_name VARCHAR(255) NOT NULL COLLATE BINARY, upload_file VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_path VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, complete_date DATETIME DEFAULT NULL, is_done BOOLEAN DEFAULT \'0\' NOT NULL, updated_at DATETIME DEFAULT NULL, due_date DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_527EDB25A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_527EDB25166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO task (id, user_id, project_id, task_name, upload_file, image_path, created_at, updated_at, complete_date, is_done, due_date) SELECT id, user_id, project_id, task_name, upload_file, image_path, created_at, updated_at, complete_date, is_done, due_date FROM __temp__task');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER NOT NULL, user_id INTEGER NOT NULL, project_id INTEGER NOT NULL, task_name VARCHAR(255) NOT NULL, upload_file VARCHAR(255) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, complete_date DATETIME DEFAULT NULL, is_done BOOLEAN DEFAULT \'0\' NOT NULL, updated_at DATETIME NOT NULL, due_date DATETIME DEFAULT NULL, PRIMARY KEY(id))');
